...
<div class="wrapper">
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{ url('public/backend/dist/img/user1-128x128.jpg')}}" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{ url('public/backend/dist/img/user3-128x128.jpg')}}" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ url('public/backend/dist/img/user1-128x128.jpg')}}" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ url('public/backend/dist/img/user7-128x128.jpg')}}" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ url('public/backend/dist/img/user3-128x128.jpg')}}" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ url('public/backend/dist/img/user5-128x128.jpg')}}" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ url('public/backend/dist/img/user6-128x128.jpg')}}" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{ url('public/backend/dist/img/user8-128x128.jpg')}}" alt="User Avatar">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2034 <a href="https://adminlte.io">HRms</a>.</strong>
    All rights reserved.
